<?php include('config.php'); ?>
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO tbl_mhs(nim, nama_mhs, jk, alamat, kota, email, foto) 
				VALUES('$nim', '$nama_mhs', '$jk', '$alamat', '$kota', '$email', '$foto')") or die(mysqli_error($koneksi));
		...
		<form action="index.php?page=tambah_mhs" method="post">
			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<input type="file" name="foto" class="form-control-file border" required>
				</div>
			</div>
