<?php include('config.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE tbl_mhs SET nama_mhs='$nama_mhs', jk='$jk', alamat='$alamat', kota='$kota', email='$email', foto='$foto' 
		...
		<form action="index.php?page=edit_mhs&nim=<?php echo $nim; ?>" method="post">
				...
				<div class="col-md-6 col-sm-6 ">
					<div class="btn-group" data-toggle="buttons">
						<label class="btn btn-secondary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
							<input type="radio" class="join-btn" name="jk" value="L" <?php if($data['jk'] == 'Laki-Laki'){ echo 'checked'; } ?> required>Laki-Laki
						</label>
						<label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
							<input type="radio" class="join-btn" name="jk" value="P" <?php if($data['jk'] == 'Perempuan'){ echo 'checked'; } ?> required>Perempuan
						</label>
					</div>
				</div>
			</div>
			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<input type="file" name="foto" class="form-control-file border" value="<?php echo $data['foto']; ?>" required>
				</div>
			</div>
